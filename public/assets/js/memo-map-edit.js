const mapEditData = window.memoMapEditData || {};
(function(){
      ...
      const defaultData = mapEditData.defaultData || null;
      let initialData = mapEditData.initialData || null;
      ...
      const initialAssetMeta = mapEditData.assetMeta || [];
