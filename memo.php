...
header("Content-Security-Policy: default-src 'self'; img-src 'self' data: blob:; style-src 'self' 'unsafe-inline'; font-src 'self' data:; script-src 'self' 'unsafe-inline'; base-uri 'self'; form-action 'self'; frame-ancestors 'self'");
...
function asset_url(string $relative): string {
  ...
  $version = is_file($full) ? (int)filemtime($full) : now();
...
if ($view === 'new') {
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?= h(asset_url('assets/css/editor.css')); ?>">
    <script defer src="<?= h(asset_url('assets/js/vendor-lite.js')); ?>"></script>
    <script defer src="<?= h(asset_url('assets/js/editor.js')); ?>"></script>
  </head>
...
<meta name="color-scheme" content="dark"/>
<link rel="stylesheet" href="<?= h(asset_url('assets/css/home.css')); ?>">
<script>window.memoData=<?= json_encode([
  'isMindmapCategory'=>$isMindmapCategory,
  'currentCategoryFilter'=>(string)$cat,
], JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>;</script>
<script defer src="<?= h(asset_url('assets/js/vendor-lite.js')); ?>"></script>
<script defer src="<?= h(asset_url('assets/js/home.js')); ?>"></script>
</head>
<body data-view="<?= $isMindmapCategory ? 'mindmaps' : 'home'; ?>">
  <div class="scanlines" aria-hidden="true"></div>
  <div class="app">
