...
if(isset($_GET['mind_export'])){
  $maps=get_mindmaps();
  header('Content-Type: application/json; charset=utf-8');
  header('Content-Disposition: attachment; filename="mindmaps_export_'.date('Ymd_His').'.json"');
...
if ($view === 'new') {
  ...
  <head>
    ...
    <style>
      ...
      *,*::before,*::after{box-sizing:border-box;animation:none!important}
      ...
      body{background:
        radial-gradient(1200px 700px at 70% -10%,rgba(227,198,139,.08),transparent 60%),
        linear-gradient(135deg,rgba(36,194,160,.08),transparent 30%,rgba(201,168,106,.08) 70%,transparent 92%),
        #0A0C0E;
      ...
      body::after{content:"";position:fixed;inset:0;background:
        ...
        mix-blend-mode:screen;opacity:.28;pointer-events:none;z-index:-3;
      }
      .scanlines{position:fixed;inset:0;pointer-events:none;z-index:-1;background:linear-gradient(to bottom,rgba(75,195,209,.12) 0,transparent 4px);background-size:100% 6px;opacity:.22}
      ...
      .btn{position:relative;display:inline-flex;align-items:center;justify-content:center;padding:10px 18px;border-radius:var(--r-sm);border:1px solid rgba(201,168,106,.55);background:linear-gradient(140deg,rgba(227,198,139,.22),rgba(36,194,160,.18));color:var(--text-strong);cursor:pointer;text-transform:uppercase;font:600 13px/1.2 'Inter','Noto Sans SC',sans-serif;letter-spacing:.12em;transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition);box-shadow:0 12px 26px rgba(0,0,0,.48),0 0 0 1px rgba(10,12,14,.4) inset;overflow:hidden}
      .btn::after{content:"";position:absolute;inset:1px;border-radius:calc(var(--r-sm) - 2px);background:linear-gradient(120deg,rgba(201,168,106,.22),rgba(75,195,209,.18));opacity:0;transition:opacity var(--transition);pointer-events:none}
      .btn:hover{transform:translateY(-2px);border-color:rgba(227,198,139,.75);box-shadow:0 18px 32px rgba(0,0,0,.55),0 0 0 1px rgba(227,198,139,.25) inset}
      .btn:hover::after{opacity:1}
      .btn:active{transform:translateY(0);box-shadow:0 10px 22px rgba(0,0,0,.45),0 0 0 1px rgba(227,198,139,.35) inset}
      .btn.acc{background:linear-gradient(140deg,rgba(227,198,139,.32),rgba(170,140,84,.3));color:var(--text-strong);box-shadow:0 14px 30px rgba(0,0,0,.5),0 0 0 1px rgba(227,198,139,.32) inset}
      ...
      .timeline::before{content:"";position:absolute;left:12px;top:0;bottom:0;width:2px;background:linear-gradient(180deg,rgba(201,168,106,.62),rgba(201,168,106,.18));box-shadow:0 0 14px rgba(201,168,106,.32)}
      ...
      .tl-item .tl-dot::after{content:"";position:absolute;inset:-6px;border-radius:inherit;border:1px dashed rgba(201,168,106,.35);box-shadow:0 0 16px rgba(201,168,106,.3)}
      ...
      *,*::before,*::after{animation:none!important;}
      body{background:
        radial-gradient(1200px 700px at 72% -12%,rgba(227,198,139,.08),transparent 60%),
        linear-gradient(135deg,rgba(36,194,160,.08),transparent 35%,rgba(201,168,106,.08) 70%,transparent 95%),
        #0A0C0E;
        background-attachment:fixed;
      }
      body::after{background:
        radial-gradient(1200px 700px at 65% -8%,rgba(227,198,139,.06),transparent 60%),
        repeating-linear-gradient(0deg,rgba(75,195,209,.08) 0,rgba(75,195,209,.08) 1px,transparent 1px,transparent var(--grid-size)),
        repeating-linear-gradient(90deg,rgba(201,168,106,.12) 0,rgba(201,168,106,.12) 1px,transparent 1px,transparent var(--grid-size));
        background-size:100% 100%,var(--grid-size) var(--grid-size),var(--grid-size) var(--grid-size);
        mix-blend-mode:screen;opacity:.28;pointer-events:none;z-index:-4;
      }
      .scanlines{opacity:.2}
      .btn{display:inline-flex;align-items:center;justify-content:center;padding:10px 18px;border-radius:16px;border:1px solid rgba(201,168,106,.58);background:linear-gradient(140deg,rgba(227,198,139,.24),rgba(36,194,160,.2));color:var(--text-strong);font:600 12px/1 'Inter','Noto Sans SC',sans-serif;letter-spacing:.14em;text-transform:uppercase;text-decoration:none;box-shadow:0 12px 26px rgba(0,0,0,.48),0 0 0 1px rgba(10,12,14,.38) inset;transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition)}
      .btn:hover{transform:translateY(-2px);border-color:rgba(227,198,139,.75);box-shadow:0 18px 32px rgba(0,0,0,.55),0 0 0 1px rgba(227,198,139,.28) inset}
      .btn.acc{background:linear-gradient(140deg,rgba(227,198,139,.32),rgba(170,140,84,.3));color:var(--text-strong)}
      ...
      body::after{background:
        radial-gradient(1200px 700px at 68% -12%,rgba(227,198,139,.06),transparent 60%),
        repeating-linear-gradient(0deg,rgba(75,195,209,.08) 0,rgba(75,195,209,.08) 1px,transparent 1px,transparent var(--grid-size)),
        repeating-linear-gradient(90deg,rgba(201,168,106,.12) 0,rgba(201,168,106,.12) 1px,transparent 1px,transparent var(--grid-size));
        background-size:100% 100%,var(--grid-size) var(--grid-size),var(--grid-size) var(--grid-size);
        mix-blend-mode:screen;opacity:.28;pointer-events:none;z-index:-3;
      ...
      .scanlines{opacity:.2}
      .btn{position:relative;display:inline-flex;align-items:center;justify-content:center;padding:10px 18px;border-radius:var(--r-sm);border:1px solid rgba(201,168,106,.55);background:linear-gradient(140deg,rgba(227,198,139,.24),rgba(36,194,160,.2));color:var(--text-strong);cursor:pointer;text-transform:uppercase;font:600 13px/1.2 'Inter','Noto Sans SC',sans-serif;letter-spacing:.12em;transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition);box-shadow:0 12px 26px rgba(0,0,0,.48),0 0 0 1px rgba(10,12,14,.38) inset;overflow:hidden}
      .btn::after{content:"";position:absolute;inset:1px;border-radius:calc(var(--r-sm) - 2px);background:linear-gradient(120deg,rgba(201,168,106,.22),rgba(75,195,209,.18));opacity:0;transition:opacity var(--transition);pointer-events:none}
      .btn:hover{transform:translateY(-2px);border-color:rgba(227,198,139,.75);box-shadow:0 18px 32px rgba(0,0,0,.55),0 0 0 1px rgba(227,198,139,.28) inset}
      .btn:hover::after{opacity:1}
      .btn:active{transform:translateY(0);box-shadow:0 10px 22px rgba(0,0,0,.45),0 0 0 1px rgba(227,198,139,.35) inset}
      .btn.acc{background:linear-gradient(140deg,rgba(227,198,139,.32),rgba(170,140,84,.3));color:var(--text-strong)}
      .timeline::before{background:linear-gradient(180deg,rgba(201,168,106,.62),rgba(201,168,106,.2));box-shadow:0 0 14px rgba(201,168,106,.32)}
      .tl-item .tl-dot::after{border:1px dashed rgba(201,168,106,.35);box-shadow:0 0 16px rgba(201,168,106,.28)}
    </style>
  </head>
  <body>
  ...
  <head>
    ...
    <style>
      ...
      *,*::before,*::after{box-sizing:border-box;animation:none!important}
      ...
      .scanlines{position:fixed;inset:0;pointer-events:none;z-index:-1;background:linear-gradient(to bottom,rgba(75,195,209,.14) 0,transparent 4px);background-size:100% 6px;opacity:.2}
      a{color:inherit;text-decoration:none}
      h1,h2,h3,h4{font-family:'Cinzel','Noto Serif SC',serif;color:var(--gold-400);letter-spacing:-0.5px;text-transform:uppercase}
      .wrap{max-width:1180px;margin:0 auto;padding:32px 24px 64px;position:relative;z-index:0}
      ...
      .btn{position:relative;display:inline-flex;align-items:center;justify-content:center;padding:10px 18px;border-radius:var(--r-sm);border:1px solid rgba(201,168,106,.52);background:linear-gradient(135deg,rgba(227,198,139,.3),rgba(36,194,160,.24));color:#0C1114;cursor:pointer;text-transform:uppercase;font:600 13px/1.2 'Inter','Noto Sans SC',sans-serif;letter-spacing:.12em;transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition);box-shadow:0 16px 32px rgba(0,0,0,.48),0 0 0 1px rgba(10,12,14,.38) inset;overflow:hidden}
      .btn::after{content:"";position:absolute;inset:1px;border-radius:calc(var(--r-sm) - 2px);background:linear-gradient(135deg,rgba(227,198,139,.24),rgba(75,195,209,.22));opacity:0;transition:opacity var(--transition);pointer-events:none}
      .btn:hover{transform:translateY(-2px);border-color:rgba(227,198,139,.75);box-shadow:0 20px 40px rgba(0,0,0,.55),0 0 0 1px rgba(227,198,139,.3) inset}
      .btn:hover::after{opacity:1}
      .btn:active{transform:translateY(0);box-shadow:0 14px 28px rgba(0,0,0,.48),0 0 0 1px rgba(227,198,139,.35) inset}
      .btn.acc{background:linear-gradient(135deg,rgba(227,198,139,.36),rgba(170,140,84,.3));color:#0C1114;box-shadow:0 20px 38px rgba(0,0,0,.5),0 0 0 1px rgba(227,198,139,.32) inset}
      .btn.danger{color:#F8E6E6;border-color:rgba(209,75,75,.6);background:linear-gradient(135deg,rgba(209,75,75,.2),rgba(120,30,30,.24));box-shadow:0 16px 34px rgba(0,0,0,.5)}
      ...
      .timeline::before{content:"";position:absolute;left:12px;top:0;bottom:0;width:2px;background:linear-gradient(180deg,rgba(201,168,106,.55),rgba(201,168,106,.12));box-shadow:0 0 12px rgba(201,168,106,.28)}
      ...
      .tl-item .tl-dot::after{content:"";position:absolute;inset:-6px;border-radius:inherit;border:1px dashed rgba(201,168,106,.36);box-shadow:0 0 16px rgba(201,168,106,.28)}
      .tl-head{display:flex;gap:12px;align-items:center;color:var(--text-strong);font-family:'Inter','Noto Sans SC',sans-serif}
      .tl-item.done .tl-head div,.tl-item.done .md-body{opacity:.72;text-decoration:line-through}
      .tl-item.done{background:linear-gradient(160deg,rgba(36,194,160,.18),rgba(15,22,20,.92));border-color:rgba(36,194,160,.42);box-shadow:0 0 28px rgba(36,194,160,.28)}
      .drag{cursor:grab;color:var(--text-muted);user-select:none;font-size:18px}
  ...
  <head>
    ...
    <style>
      ...
      *,*::before,*::after{box-sizing:border-box;animation:none!important}
      ...
      body{background:
        radial-gradient(1200px 700px at 72% -10%,rgba(227,198,139,.08),transparent 60%),
        linear-gradient(135deg,rgba(36,194,160,.08),transparent 30%,rgba(201,168,106,.08) 70%,transparent 92%),
        #0A0C0E;
        background-attachment:fixed;
      }
      ...
      body::after{content:"";position:fixed;inset:0;background:
        ...
        repeating-linear-gradient(90deg,rgba(201,168,106,.12) 0,rgba(201,168,106,.12) 1px,transparent 1px,transparent var(--grid-size));
        background-size:var(--grid-size) var(--grid-size);
        mix-blend-mode:screen;opacity:.3;pointer-events:none;z-index:-3;
      }
      .scanlines{position:fixed;inset:0;pointer-events:none;z-index:-1;background:linear-gradient(to bottom,rgba(75,195,209,.12) 0,transparent 4px);background-size:100% 6px;opacity:.22}
      a{color:inherit;text-decoration:none}
      ...
      .mind-info-handle{align-self:center;display:flex;align-items:center;justify-content:center;width:36px;height:20px;border-radius:999px;border:1px solid rgba(201,168,106,.55);background:linear-gradient(135deg,rgba(227,198,139,.22),rgba(36,194,160,.2));color:var(--text-strong);font:600 12px/1 'Inter','Noto Sans SC',sans-serif;letter-spacing:.16em;text-transform:uppercase;cursor:pointer;transition:background var(--t-fast) var(--ease),border-color var(--t-fast) var(--ease),transform var(--t-fast) var(--ease),box-shadow var(--t-fast) var(--ease);margin-bottom:4px;box-shadow:0 10px 22px rgba(0,0,0,.45),0 0 0 1px rgba(10,12,14,.38) inset}
      .mind-info-handle .icon{font-size:14px;line-height:1}
      .mind-info-handle:hover{background:linear-gradient(135deg,rgba(227,198,139,.28),rgba(75,195,209,.24));border-color:rgba(227,198,139,.7);box-shadow:0 14px 24px rgba(0,0,0,.5),0 0 0 1px rgba(227,198,139,.28) inset}
      ...
      .map-io-button{padding:10px 16px;border-radius:16px;border:1px solid rgba(201,168,106,.6);background:linear-gradient(140deg,rgba(227,198,139,.26),rgba(36,194,160,.2));color:var(--text-strong);font:600 12px/1 'Inter','Noto Sans SC',sans-serif;letter-spacing:.12em;text-transform:uppercase;cursor:pointer;transition:background var(--t-fast) var(--ease),border-color var(--t-fast) var(--ease),transform var(--t-fast) var(--ease),box-shadow var(--t-fast) var(--ease);box-shadow:0 12px 28px rgba(0,0,0,.5),0 0 0 1px rgba(10,12,14,.38) inset}
      .map-io-button:hover{background:linear-gradient(140deg,rgba(227,198,139,.32),rgba(75,195,209,.24));border-color:rgba(227,198,139,.75);transform:translateY(-1px);box-shadow:0 16px 30px rgba(0,0,0,.55),0 0 0 1px rgba(227,198,139,.28) inset}
      .map-io-button:focus-visible{outline:3px solid rgba(75,195,209,.35);outline-offset:2px}
      .map-io[aria-expanded="true"] .map-io-button{background:linear-gradient(140deg,rgba(227,198,139,.34),rgba(75,195,209,.26))}
      .map-io-menu{position:absolute;top:calc(100% + 10px);right:0;display:none;flex-direction:column;gap:8px;padding:12px;border-radius:16px;border:1px solid rgba(201,168,106,.36);background:linear-gradient(180deg,rgba(21,26,30,.95),rgba(12,16,18,.9));box-shadow:0 18px 42px rgba(0,0,0,.55);min-width:200px;z-index:30}
      .map-io[aria-expanded="true"] .map-io-menu{display:flex}
      .map-io-menu button{padding:12px 14px;border-radius:12px;border:1px solid rgba(201,168,106,.45);background:linear-gradient(135deg,rgba(227,198,139,.18),rgba(36,194,160,.18));color:var(--text-strong);font:600 13px/1 'Inter','Noto Sans SC',sans-serif;letter-spacing:.12em;text-transform:uppercase;cursor:pointer;transition:border-color var(--transition),background-color var(--transition),color var(--transition);text-align:left;box-shadow:0 12px 24px rgba(0,0,0,.45),0 0 0 1px rgba(10,12,14,.35) inset}
      .map-io-menu button:hover{border-color:rgba(227,198,139,.72);background:linear-gradient(135deg,rgba(227,198,139,.24),rgba(75,195,209,.22));color:var(--text-strong)}
      .map-back{display:inline-flex;align-items:center;gap:6px;padding:8px 12px;border-radius:999px;border:1px solid rgba(201,168,106,.6);background:linear-gradient(135deg,rgba(227,198,139,.24),rgba(36,194,160,.2));font:600 12px/1 'Inter','Noto Sans SC',sans-serif;letter-spacing:.16em;text-transform:uppercase;color:var(--text-strong);transition:background var(--transition),border-color var(--transition),transform var(--transition),box-shadow var(--transition);box-shadow:0 10px 20px rgba(0,0,0,.45),0 0 0 1px rgba(10,12,14,.35) inset}
      .map-back:hover{border-color:rgba(227,198,139,.75);background:linear-gradient(135deg,rgba(227,198,139,.28),rgba(75,195,209,.24));transform:translateY(-1px);box-shadow:0 14px 26px rgba(0,0,0,.5),0 0 0 1px rgba(227,198,139,.25) inset}
      ...
      @media (max-width:720px){
        ...
        .mind-info-row{gap:8px;flex-wrap:wrap;justify-content:center;text-align:center}
        .mind-info-row .map-title-input{max-width:280px;margin:4px auto;text-align:center}
        .map-io{width:100%;display:flex;justify-content:center}
        .save-state{margin:4px auto 0;font-size:10px;padding:4px 10px}
        .map-back{padding:5px 9px;font-size:11px}
        .map-title-input{padding:8px 12px;font-size:15px}
        .map-meta{font-size:10px;gap:8px;letter-spacing:.12em;justify-content:space-between;text-align:left}
      ...
      .jsmind-node::before{content:"";position:absolute;inset:10px;border-radius:calc(var(--r-md) - 4px);border:1px solid rgba(201,168,106,.22);opacity:.75;pointer-events:none;box-shadow:0 0 22px rgba(227,198,139,.18)}
      .jsmind-node::after{content:"";position:absolute;inset:-14px;border-radius:calc(var(--r-md) + 10px);border:1px dashed rgba(201,168,106,.22);opacity:0;pointer-events:none;box-shadow:0 0 26px rgba(227,198,139,.18)}
      ...
      .jsmind-node.isroot::after{opacity:.45;transform:scale(1);box-shadow:0 0 32px rgba(227,198,139,.24)}
      ...
      .jsmind-node.selected::after{opacity:.55;box-shadow:0 0 36px rgba(227,198,139,.26)}
      ...
      .dock-btn{position:relative;display:grid;grid-template-rows:auto auto;align-items:center;justify-items:center;width:92px;height:66px;border-radius:18px;padding:8px 6px;background:linear-gradient(150deg,rgba(227,198,139,.2),rgba(36,194,160,.18));border:1px solid rgba(201,168,106,.5);color:var(--text-strong);font:600 13px/1 'Inter','Noto Sans SC',sans-serif;text-transform:uppercase;letter-spacing:.12em;cursor:pointer;transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition),background-color var(--transition);touch-action:manipulation;flex:0 0 auto;scroll-snap-align:center;box-shadow:0 12px 26px rgba(0,0,0,.45),0 0 0 1px rgba(10,12,14,.32) inset}
      .dock-btn .icon{font-size:20px}
      .dock-btn .label{font-size:12px}
      .dock-btn:hover{transform:translateY(-3px);border-color:rgba(227,198,139,.72);background:linear-gradient(150deg,rgba(227,198,139,.26),rgba(75,195,209,.22));box-shadow:0 16px 30px rgba(0,0,0,.5)}
      ...
      .map-import-dialog{position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(6,8,10,.72);backdrop-filter:blur(12px);z-index:250;opacity:0;pointer-events:none;transition:opacity var(--t-fast) var(--ease)}
      .map-import-dialog.show{opacity:1;pointer-events:auto}
      .map-import-dialog__panel{position:relative;max-width:380px;width:calc(100% - 40px);padding:24px;border-radius:22px;border:1px solid rgba(201,168,106,.42);background:linear-gradient(180deg,rgba(21,26,30,.96),rgba(12,16,18,.92));box-shadow:0 28px 60px rgba(0,0,0,.65),0 0 36px rgba(227,198,139,.18) inset;display:grid;gap:18px}
      .map-import-dialog__close{position:absolute;top:14px;right:16px;width:32px;height:32px;border-radius:50%;border:1px solid rgba(201,168,106,.4);background:rgba(201,168,106,.1);color:var(--text-strong);font-size:18px;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:background var(--t-fast) var(--ease),border-color var(--t-fast) var(--ease)}
      .map-import-dialog__close:hover{background:rgba(201,168,106,.22);border-color:rgba(227,198,139,.6)}
      .map-import-dialog__title{margin:0;font:600 18px/1.3 'Cinzel','Noto Serif SC',serif;color:var(--gold-400);letter-spacing:.12em;text-transform:uppercase}
      .map-import-dialog__hint{margin:0;color:var(--text-muted);font:500 13px/1.6 'Inter','Noto Sans SC',sans-serif}
      .map-import-dialog__hint strong{color:var(--text-strong)}
      .map-import-dialog__actions{display:grid;gap:12px}
      .map-import-dialog__actions button{padding:12px 16px;border-radius:14px;border:1px solid rgba(201,168,106,.52);background:linear-gradient(135deg,rgba(227,198,139,.24),rgba(36,194,160,.2));color:var(--text-strong);font:600 13px/1 'Inter','Noto Sans SC',sans-serif;letter-spacing:.12em;text-transform:uppercase;cursor:pointer;transition:background var(--transition),border-color var(--transition),transform var(--transition),box-shadow var(--transition);box-shadow:0 14px 30px rgba(0,0,0,.5),0 0 0 1px rgba(10,12,14,.35) inset}
      .map-import-dialog__actions button:hover{transform:translateY(-1px);border-color:rgba(227,198,139,.75);background:linear-gradient(135deg,rgba(227,198,139,.28),rgba(75,195,209,.24));box-shadow:0 18px 34px rgba(0,0,0,.55)}
      .map-import-dialog__actions button[data-mode="cancel"]{border-color:rgba(201,168,106,.28);background:rgba(21,26,30,.82);box-shadow:0 10px 24px rgba(0,0,0,.45)}
      .map-import-dialog__actions button[data-mode="cancel"]:hover{border-color:rgba(201,168,106,.4);background:rgba(21,26,30,.9)}
    </style>
...
标签：#重要 #任务"></textarea>
    ...
    <div id="import-mode-dialog" class="map-import-dialog" aria-hidden="true" hidden>
      <div class="map-import-dialog__panel" role="dialog" aria-modal="true" aria-labelledby="import-mode-title">
        <button type="button" class="map-import-dialog__close" data-mode="cancel" aria-label="取消导入">×</button>
        <h2 class="map-import-dialog__title" id="import-mode-title">选择导入方式</h2>
        <p class="map-import-dialog__hint">已选择：<strong data-file-name>JSON 文件</strong></p>
        <div class="map-import-dialog__actions">
          <button type="button" data-mode="replace">覆盖当前导图</button>
          <button type="button" data-mode="append-node">导入为新节点</button>
          <button type="button" data-mode="new-map">导入为新导图</button>
          <button type="button" data-mode="cancel">取消</button>
        </div>
      </div>
    </div>
    <script>
    ...
    const jm=new jsMind({
      ...
      const importModeNameEl=importModeDialog ? importModeDialog.querySelector('[data-file-name]') : null;
      const importModeButtons=importModeDialog ? Array.from(importModeDialog.querySelectorAll('button[data-mode]')) : [];
      ...
      function askImportMode(fileName){
        if(!importModeDialog || !importModeButtons.length){
          return Promise.resolve('replace');
        }
        return new Promise(resolve=>{
          const previousActive=document.activeElement instanceof HTMLElement ? document.activeElement : null;
          if(importModeNameEl){ importModeNameEl.textContent=fileName || 'JSON 文件'; }
          importModeDialog.hidden=false;
          importModeDialog.setAttribute('aria-hidden','false');
          requestAnimationFrame(()=>importModeDialog.classList.add('show'));
          ...
          const handleBackdrop=event=>{
            if(event.target===importModeDialog){ close(null); }
          };
          const handleKeydown=event=>{
            if(event.key==='Escape'){ event.preventDefault(); close(null); }
          };
          const close=result=>{
            importModeDialog.classList.remove('show');
            importModeDialog.setAttribute('aria-hidden','true');
            importModeDialog.hidden=true;
            importModeButtons.forEach(btn=>btn.removeEventListener('click',handleClick));
            importModeDialog.removeEventListener('click',handleBackdrop);
            document.removeEventListener('keydown',handleKeydown,true);
            if(previousActive && typeof previousActive.focus==='function'){ previousActive.focus(); }
            resolve(result);
          };
          importModeButtons.forEach(btn=>btn.addEventListener('click',handleClick));
          importModeDialog.addEventListener('click',handleBackdrop);
          document.addEventListener('keydown',handleKeydown,true);
          const primary=importModeButtons.find(btn=>btn.getAttribute('data-mode')==='replace') || importModeButtons[0];
        ...
        importInput.addEventListener('change', e=>{
          ...
          reader.onload=async evt=>{
            try{
              ...
              const mode=await askImportMode(file.name || 'JSON 文件');
              if(!mode) return;
              commitInlineEditing();
              ...
              switch(mode){
                case 'replace':
                  ...
                  break;
                case 'append-node':
                  importJsonAsSubtree(json);
                  break;
                case 'new-map':
                  importJsonAsNewMap(json);
                  break;
              }
  ...
  <head>
    ...
    <style>
      ...
      *,*::before,*::after{box-sizing:border-box}
      ...
      body{background:
        radial-gradient(1200px 720px at 68% -12%,rgba(227,198,139,.08),transparent 60%),
        radial-gradient(980px 640px at 12% 18%,rgba(36,194,160,.08),transparent 68%),
        linear-gradient(125deg,rgba(201,168,106,.08),rgba(10,12,14,.96) 62%),
        #050607;
        background-attachment:fixed;
      }
      body::before{content:"";position:fixed;inset:0;background:
      ...
      body::after{content:"";position:fixed;inset:0;background:
        ...
        repeating-linear-gradient(90deg,rgba(201,168,106,.12) 0,rgba(201,168,106,.12) 1px,transparent 1px,transparent var(--grid-size));
        background-size:var(--grid-size) var(--grid-size);
        mix-blend-mode:screen;opacity:.32;pointer-events:none;z-index:-4;
      }
      ...
      .btn{position:relative;display:inline-flex;align-items:center;justify-content:center;padding:12px 18px;border-radius:16px;border:1px solid rgba(201,168,106,.52);background:linear-gradient(135deg,rgba(227,198,139,.32),rgba(36,194,160,.26));color:#0C1114;font:600 12px/1 'Inter','Noto Sans SC',sans-serif;text-transform:uppercase;letter-spacing:.16em;cursor:pointer;transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition);box-shadow:0 18px 34px rgba(0,0,0,.45),0 0 0 1px rgba(10,12,14,.38) inset;overflow:hidden}
      .btn::after{content:"";position:absolute;inset:1px;border-radius:calc(16px - 2px);background:linear-gradient(135deg,rgba(227,198,139,.28),rgba(75,195,209,.26));opacity:0;transition:opacity var(--transition);pointer-events:none}
      .btn:hover{transform:translateY(-2px);border-color:rgba(227,198,139,.75);box-shadow:0 22px 40px rgba(0,0,0,.52),0 0 0 1px rgba(227,198,139,.3) inset}
      .btn:hover::after{opacity:1}
      .btn:active{transform:translateY(0);box-shadow:0 14px 28px rgba(0,0,0,.48),0 0 0 1px rgba(227,198,139,.35) inset}
      .btn.acc{background:linear-gradient(135deg,rgba(227,198,139,.38),rgba(170,140,84,.34));color:#0C1114;box-shadow:0 20px 40px rgba(0,0,0,.5),0 0 0 1px rgba(227,198,139,.34) inset}
      ...
      .grid{margin-top:28px;display:grid;gap:18px;grid-template-columns:repeat(auto-fit,minmax(220px,1fr))}
      ...
      .card::before{content:"";position:absolute;inset:12px;border-radius:20px;box-shadow:inset 0 0 0 1px rgba(227,198,139,.22),inset 0 0 40px rgba(227,198,139,.08);pointer-events:none;opacity:.85}
  ...
  <div class="wrap">
      <div class="header">
        ...
        <div style="display:flex;gap:10px;flex-wrap:wrap;justify-content:flex-end">
          ...
          <button class="btn" type="button" id="import-map-btn">导入导图</button>
          <button class="btn" type="button" id="export-all-btn">导出全部</button>
    ...
    <input id="import-map-input" type="file" accept="application/json" hidden>
    <script>
        ...
        importInput.addEventListener('change',e=>{
          ...
          reader.onload=async evt=>{
            try{
              ...
              fd.append('action','save_mindmap');
              fd.append('id','0');
              const title=(json?.meta?.name || json?.data?.topic || '导入导图').trim();
              fd.append('title', title || '导入导图');
              ...
              alert('导入成功，已创建新导图。');
              location.href='<?= htmlspecialchars($_SERVER['PHP_SELF'].'?view=map_edit&id=') ?>'+data.id;
            }catch(err){
      ...
      if(exportBtn){
        exportBtn.addEventListener('click',async ()=>{
          try{
            ...
            const res=await fetch('<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>?mind_export=json');
            if(!res.ok) throw new Error('导出失败');
            const blob=await res.blob();
            const url=URL.createObjectURL(blob);
            const a=document.createElement('a');
            a.href=url;
            a.download='mindmaps_export_'+new Date().toISOString().replace(/[:T]/g,'-').split('.')[0]+'.json';
            a.click();
            setTimeout(()=>URL.revokeObjectURL(url),1000);
          }catch(err){
...
<style>
  ...
  *,*::before,*::after{box-sizing:border-box;animation:none!important}
  ...
  body::after{content:"";position:fixed;inset:0;background:
      radial-gradient(1200px 720px at 68% -12%,rgba(227,198,139,.08),transparent 65%),
      linear-gradient(140deg,rgba(36,194,160,.1),transparent 40%,rgba(201,168,106,.08) 82%),
  ...
  .scanlines{position:fixed;inset:0;pointer-events:none;z-index:-1;background:linear-gradient(to bottom,rgba(75,195,209,.14) 0,transparent 4px);background-size:100% 6px;opacity:.2}
  a{color:inherit;text-decoration:none}
  .app{display:block;position:relative;z-index:0;min-height:100vh}
  .sidebar{position:fixed;top:0;left:0;width:280px;height:100vh;overflow:auto;background:linear-gradient(165deg,rgba(12,14,18,.94),rgba(15,19,22,.9));border-right:1px solid var(--border);box-shadow:inset 0 0 0 1px rgba(201,168,106,.08),0 18px 45px rgba(0,0,0,.45);padding:20px 20px 32px;backdrop-filter:blur(18px) saturate(170%);}
  ...
  .btn{position:relative;display:inline-flex;align-items:center;justify-content:center;padding:10px 16px;border-radius:14px;border:1px solid rgba(201,168,106,.58);background:linear-gradient(140deg,rgba(227,198,139,.28),rgba(36,194,160,.22));color:#0C1114;font:600 12px/1 'Inter','Noto Sans SC',sans-serif;letter-spacing:.14em;text-transform:uppercase;text-decoration:none;box-shadow:0 18px 34px rgba(0,0,0,.48),0 0 0 1px rgba(10,12,14,.38) inset;transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition);overflow:hidden}
  .btn::after{content:"";position:absolute;inset:1px;border-radius:calc(14px - 2px);background:linear-gradient(135deg,rgba(227,198,139,.24),rgba(75,195,209,.22));opacity:0;transition:opacity var(--transition);pointer-events:none}
  .btn:hover{transform:translateY(-2px);border-color:rgba(227,198,139,.75);box-shadow:0 22px 40px rgba(0,0,0,.55),0 0 0 1px rgba(227,198,139,.3) inset}
  .btn:hover::after{opacity:1}
  .btn:active{transform:translateY(0);box-shadow:0 14px 28px rgba(0,0,0,.48),0 0 0 1px rgba(227,198,139,.36) inset}
  .btn.acc{background:linear-gradient(140deg,rgba(227,198,139,.34),rgba(170,140,84,.32));color:#0C1114;box-shadow:0 20px 40px rgba(0,0,0,.5),0 0 0 1px rgba(227,198,139,.32) inset}
  .btn.danger{color:#F6D6D6;border-color:rgba(209,75,75,.6);background:linear-gradient(140deg,rgba(209,75,75,.2),rgba(120,30,30,.24));box-shadow:0 14px 28px rgba(0,0,0,.5)}
  ...
  .main{margin-left:280px;min-height:100vh;padding:24px 20px;background:linear-gradient(160deg,rgba(12,14,18,.82),rgba(10,12,14,.85));backdrop-filter:blur(14px) saturate(160%);position:relative}
  ...
  .items{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px;position:relative}
  ...
  .item::before{content:"";position:absolute;inset:6px;border-radius:14px;border:1px dashed rgba(201,168,106,.24);opacity:.75;pointer-events:none;box-shadow:inset 0 0 32px rgba(201,168,106,.05)}
  .item::after{content:"";position:absolute;top:14px;right:16px;width:11px;height:11px;border-radius:50%;background:var(--danger);box-shadow:0 0 12px var(--danger)}
  ...
  .item.done::before{opacity:1;border-style:double;border-color:rgba(201,168,106,.45);box-shadow:inset 0 0 32px rgba(201,168,106,.12)}
  ...
  .tinyline::before{content:"";position:absolute;left:6px;top:0;bottom:0;width:2px;background:linear-gradient(to bottom,rgba(201,168,106,.55),rgba(201,168,106,.18));box-shadow:0 0 12px rgba(201,168,106,.24)}
  ...
  .dot::after{content:"";position:absolute;inset:-5px;border-radius:50%;border:1px dashed rgba(201,168,106,.35);box-shadow:0 0 14px rgba(201,168,106,.28)}
  ...
  .desk-move{display:flex;gap:6px;align-items:center}
  ...
  @media (max-width:920px){
    .sidebar{position:static;width:auto;height:auto;overflow:visible;border-right:0;border-bottom:1px solid rgba(201,168,106,.18);border-radius:0 0 22px 22px;box-shadow:0 18px 40px rgba(0,0,0,.55);padding:20px}
    .main{margin-left:0}
      ...
      <?php foreach ($items as $it): ?>
        ...
        <article class="item <?php echo $it['done']?'done':''; ?>" data-id="<?php echo $it['id']; ?>">
          ...
          <div class="item-actions">
            ...
            <span class="tip note-tip">↔ 使用方向按钮排序</span>
            <div class="desk-move">
              <button class="btn small" type="button" onclick="moveCard(<?php echo $it['id']; ?>,'left')">← 左移</button>
              <button class="btn small" type="button" onclick="moveCard(<?php echo $it['id']; ?>,'right')">→ 右移</button>
            </div>
            <div class="mob-move">
              <button class="btn small" type="button" onclick="moveCard(<?php echo $it['id']; ?>,'up')">↑ 上移</button>
              <button class="btn small" type="button" onclick="moveCard(<?php echo $it['id']; ?>,'down')">↓ 下移</button>
            </div>
...
const layoutColumns=()=>window.matchMedia('(max-width: 920px)').matches?1:3;
function moveCard(id, direction){
  const grid=$('#items');
  if(!grid) return;
  const cards=Array.from(grid.querySelectorAll('article.item'));
  const index=cards.findIndex(el=>el.dataset.id===String(id));
  if(index<0) return;
  const columns=layoutColumns();
  let targetIndex=index;
  switch(direction){
    case 'left':
      if(columns<=1 || index%columns===0) return;
      targetIndex=index-1;
      break;
    case 'right':
      if(columns<=1 || index%columns===columns-1 || index===cards.length-1) return;
      targetIndex=index+1;
      break;
    case 'up':
    ...
    default:
      if(typeof direction==='number' && direction!==0){
        targetIndex=Math.max(0, Math.min(cards.length-1, index+direction));
      }else{
        return;
      }
  }
  ...
  const reference=targetIndex>index ? target.nextElementSibling : target;
