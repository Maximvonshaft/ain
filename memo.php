  ...
  <head>
    ...
    <style>
      ...
      *,*::before,*::after{box-sizing:border-box}
      ...
      .btn{position:relative;display:inline-flex;align-items:center;justify-content:center;padding:10px 18px;border-radius:var(--r-sm);border:1px solid rgba(227,198,139,.6);background:linear-gradient(135deg,rgba(227,198,139,.85),rgba(170,140,84,.7));color:#1d1206;cursor:pointer;text-transform:uppercase;font:600 13px/1.2 'Inter','Noto Sans SC',sans-serif;letter-spacing:.12em;transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition);box-shadow:0 0 18px rgba(227,198,139,.25);overflow:hidden}
      .btn::after{content:none}
      .btn:hover{transform:translateY(-2px);border-color:rgba(227,198,139,.85);box-shadow:0 0 26px rgba(227,198,139,.32)}
      .btn:active{transform:translateY(0);background:linear-gradient(135deg,rgba(201,168,106,.75),rgba(170,140,84,.58));border-color:var(--gold-700)}
      .btn.acc{background:linear-gradient(135deg,rgba(75,195,209,.85),rgba(36,194,160,.82));color:#041512;box-shadow:0 0 22px rgba(75,195,209,.35);border-color:rgba(75,195,209,.65)}
      ...
      .timeline::before{content:"";position:absolute;left:12px;top:0;bottom:0;width:2px;background:linear-gradient(180deg,rgba(201,168,106,.65),rgba(201,168,106,.08));box-shadow:0 0 16px rgba(201,168,106,.25)}
      ...
      .tl-item .tl-dot::after{content:"";position:absolute;inset:-6px;border-radius:inherit;border:1px dashed rgba(201,168,106,.35);box-shadow:0 0 12px rgba(201,168,106,.25);opacity:.9}
  ...
  <head>
    ...
    <style>
      ...
      *,*::before,*::after{box-sizing:border-box}
      ...
      .btn:active{transform:translateY(0);background:linear-gradient(135deg,rgba(201,168,106,.75),rgba(170,140,84,.58));border-color:var(--gold-700)}
      .btn.acc{background:linear-gradient(135deg,rgba(75,195,209,.85),rgba(36,194,160,.82));color:#041512;box-shadow:0 0 22px rgba(75,195,209,.35);border-color:rgba(75,195,209,.65)}
      .btn.danger{color:#250b0b;border-color:rgba(209,75,75,.6);background:linear-gradient(135deg,rgba(255,140,140,.8),rgba(209,75,75,.75));box-shadow:0 0 18px rgba(209,75,75,.28)}
  ...
  <head>
    ...
    <style>
      ...
      *,*::before,*::after{box-sizing:border-box}
      ...
      .mind-info-handle{align-self:center;display:flex;align-items:center;justify-content:center;width:36px;height:20px;border-radius:999px;border:1px solid rgba(227,198,139,.6);background:linear-gradient(135deg,rgba(227,198,139,.7),rgba(170,140,84,.55));color:#1d1206;font:600 12px/1 'Inter','Noto Sans SC',sans-serif;letter-spacing:.16em;text-transform:uppercase;cursor:pointer;transition:background var(--t-fast) var(--ease),border-color var(--t-fast) var(--ease),transform var(--t-fast) var(--ease),box-shadow var(--t-fast) var(--ease);margin-bottom:4px;box-shadow:0 0 18px rgba(227,198,139,.22)}
      .mind-info-handle .icon{font-size:14px;line-height:1}
      .mind-info-handle:hover{background:linear-gradient(135deg,rgba(227,198,139,.82),rgba(170,140,84,.65));border-color:rgba(227,198,139,.72);box-shadow:0 0 24px rgba(227,198,139,.3)}
      ...
      .map-io-button{padding:10px 16px;border-radius:16px;border:1px solid rgba(227,198,139,.62);background:linear-gradient(135deg,rgba(227,198,139,.8),rgba(170,140,84,.62));color:#1b1206;font:600 12px/1 'Inter','Noto Sans SC',sans-serif;letter-spacing:.12em;text-transform:uppercase;cursor:pointer;transition:transform var(--t-fast) var(--ease),border-color var(--t-fast) var(--ease),box-shadow var(--t-fast) var(--ease)}
      .map-io-button:hover{transform:translateY(-2px);border-color:rgba(227,198,139,.8);box-shadow:0 0 24px rgba(227,198,139,.28)}
      .map-io-button:focus-visible{outline:3px solid rgba(75,195,209,.35);outline-offset:2px}
      .map-io[aria-expanded="true"] .map-io-button{box-shadow:0 0 26px rgba(227,198,139,.34)}
      .map-io-menu{position:absolute;top:calc(100% + 10px);right:0;display:none;flex-direction:column;gap:8px;padding:16px;border-radius:16px;border:1px solid rgba(227,198,139,.45);background:linear-gradient(180deg,rgba(21,26,30,.96),rgba(12,16,18,.92));box-shadow:0 16px 42px rgba(0,0,0,.55);min-width:240px;z-index:30}
      .map-io[aria-expanded="true"] .map-io-menu{display:flex}
      .map-io-menu .menu-title{font:600 11px/1 'Inter','Noto Sans SC',sans-serif;letter-spacing:.18em;text-transform:uppercase;color:var(--text-muted)}
      .map-io-menu .menu-separator{height:1px;background:rgba(201,168,106,.28);margin:6px 0}
      .map-io-menu button{padding:10px 14px;border-radius:12px;border:1px solid rgba(227,198,139,.45);background:linear-gradient(135deg,rgba(227,198,139,.18),rgba(21,26,30,.92));color:var(--gold-400);font:600 13px/1 'Inter','Noto Sans SC',sans-serif;letter-spacing:.12em;text-transform:uppercase;cursor:pointer;transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition);text-align:left}
      .map-io-menu button:hover{transform:translateX(2px);border-color:rgba(227,198,139,.7);box-shadow:0 0 22px rgba(227,198,139,.25)}
      .map-back{display:inline-flex;align-items:center;gap:6px;padding:8px 12px;border-radius:999px;border:1px solid rgba(227,198,139,.6);background:linear-gradient(135deg,rgba(227,198,139,.82),rgba(170,140,84,.62));font:600 12px/1 'Inter','Noto Sans SC',sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#1c1208;transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition)}
      .map-back:hover{border-color:rgba(227,198,139,.82);transform:translateY(-1px);box-shadow:0 0 22px rgba(227,198,139,.3)}
      ...
      .map-delete-btn{margin-left:auto;padding:6px 12px;border-radius:12px;border:1px solid rgba(209,75,75,.65);background:linear-gradient(135deg,rgba(255,140,140,.82),rgba(209,75,75,.72));color:#250b0b;font:600 11px/1 'Inter','Noto Sans SC',sans-serif;letter-spacing:.14em;text-transform:uppercase;cursor:pointer;transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition)}
      .map-delete-btn:hover{border-color:rgba(209,75,75,.85);transform:translateY(-1px);box-shadow:0 0 20px rgba(209,75,75,.32)}
      ...
      @media (max-width:720px){
        ...
        .mind-info-row .map-title-input{flex:1 1 100%;max-width:260px;margin:0 auto;padding:8px 12px;font-size:15px;text-align:center}
        .map-io{width:100%;display:flex;justify-content:center}
        .map-io-button{width:100%;max-width:240px}
        .map-back{padding:5px 9px;font-size:11px}
        .save-state{font-size:10px;padding:4px 10px}
        .map-meta{font-size:10px;gap:8px;letter-spacing:.12em;justify-content:center}
        .map-meta span{flex:1 1 auto;min-width:0;text-align:center}
      }
      ...
      .jsmind-node::before{content:"";position:absolute;inset:10px;border-radius:calc(var(--r-md) - 4px);border:1px solid rgba(201,168,106,.22);opacity:.75;pointer-events:none;box-shadow:inset 0 0 18px rgba(227,198,139,.16)}
      .jsmind-node::after{content:"";position:absolute;inset:-14px;border-radius:calc(var(--r-md) + 10px);border:1px dashed rgba(201,168,106,.22);opacity:.35;pointer-events:none;box-shadow:0 0 28px rgba(227,198,139,.18)}
      ...
      .jsmind-node.isroot::after{opacity:.55}
      ...
      .jsmind-node.selected::after{opacity:.75}
      ...
      .dock-btn{position:relative;display:grid;grid-template-rows:auto auto;align-items:center;justify-items:center;width:92px;height:66px;border-radius:18px;padding:8px 6px;background:linear-gradient(160deg,rgba(227,198,139,.18),rgba(21,26,30,.9));border:1px solid rgba(227,198,139,.45);color:var(--gold-400);font:600 13px/1 'Inter','Noto Sans SC',sans-serif;text-transform:uppercase;letter-spacing:.12em;cursor:pointer;transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition);touch-action:manipulation;flex:0 0 auto;scroll-snap-align:center;box-shadow:0 0 18px rgba(227,198,139,.2)}
      .dock-btn .icon{font-size:20px}
      .dock-btn .label{font-size:12px}
      .dock-btn:hover{transform:translateY(-3px);border-color:rgba(227,198,139,.72);box-shadow:0 0 30px rgba(227,198,139,.26)}
      ...
      .dock-btn.danger{color:#250b0b;border-color:rgba(209,75,75,.65);background:linear-gradient(150deg,rgba(255,140,140,.82),rgba(209,75,75,.72));box-shadow:0 0 24px rgba(209,75,75,.28)}
      ...
      .node-popover button.close{background:linear-gradient(135deg,rgba(227,198,139,.7),rgba(170,140,84,.55));border:1px solid rgba(227,198,139,.62);border-radius:999px;color:#1d1206;width:32px;height:32px;cursor:pointer;box-shadow:0 0 16px rgba(227,198,139,.22);transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition)}
      .node-popover button.close:hover{transform:translateY(-1px);border-color:rgba(227,198,139,.78);box-shadow:0 0 22px rgba(227,198,139,.3)}
      ...
      .node-popover .popover-actions button{padding:10px 16px;border-radius:14px;border:1px solid rgba(227,198,139,.55);background:linear-gradient(135deg,rgba(227,198,139,.8),rgba(170,140,84,.6));color:#1d1206;font:600 12px/1 'Inter','Noto Sans SC',sans-serif;letter-spacing:.12em;text-transform:uppercase;cursor:pointer;transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition)}
      .node-popover .popover-actions button.accent{background:linear-gradient(135deg,rgba(75,195,209,.85),rgba(36,194,160,.8));border-color:rgba(75,195,209,.65);color:#041512}
      .node-popover .popover-actions button:hover{transform:translateY(-2px);border-color:rgba(227,198,139,.78);box-shadow:0 0 24px rgba(227,198,139,.28)}
      ...
      .node-context-menu button{padding:10px 12px;border-radius:12px;border:1px solid rgba(227,198,139,.48);background:linear-gradient(135deg,rgba(227,198,139,.2),rgba(21,26,30,.88));color:var(--gold-400);font:600 13px/1 'Inter','Noto Sans SC',sans-serif;letter-spacing:.12em;text-transform:uppercase;cursor:pointer;transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition)}
      .node-context-menu button:hover{transform:translateX(2px);border-color:rgba(227,198,139,.7);box-shadow:0 0 20px rgba(227,198,139,.24)}
      ...
      .mind-settings .settings-panel button.close{width:32px;height:32px;border-radius:999px;border:1px solid rgba(227,198,139,.62);background:linear-gradient(135deg,rgba(227,198,139,.7),rgba(170,140,84,.55));color:#1d1206;cursor:pointer;box-shadow:0 0 16px rgba(227,198,139,.22);transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition)}
      .mind-settings .settings-panel button.close:hover{transform:translateY(-1px);border-color:rgba(227,198,139,.78);box-shadow:0 0 22px rgba(227,198,139,.3)}
      .mind-settings .settings-actions{display:flex;justify-content:flex-end;gap:10px}
      .mind-settings .settings-actions button{padding:10px 14px;border-radius:14px;border:1px solid rgba(227,198,139,.55);background:linear-gradient(135deg,rgba(227,198,139,.8),rgba(170,140,84,.6));color:#1d1206;font:600 12px/1 'Inter','Noto Sans SC',sans-serif;letter-spacing:.12em;text-transform:uppercase;cursor:pointer;transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition)}
      .mind-settings .settings-actions button:hover{transform:translateY(-2px);border-color:rgba(227,198,139,.78);box-shadow:0 0 24px rgba(227,198,139,.28)}
            ...
            <div class="mind-info-row">
              ...
              <div class="map-io" id="map-io" aria-expanded="false">
                ...
                <div class="map-io-menu" id="map-io-menu" role="menu">
                  <div class="menu-title" aria-hidden="true">导入导图</div>
                  <button type="button" data-action="import" data-mode="replace" role="menuitem">覆盖当前导图</button>
                  <button type="button" data-action="import" data-mode="append-node" role="menuitem">导入为新节点</button>
                  <button type="button" data-action="import" data-mode="new-map" role="menuitem">导入为新导图</button>
                  <div class="menu-separator" role="separator"></div>
                  <button type="button" data-action="export" role="menuitem">导出当前导图</button>
                </div>
              </div>
...
标签：#重要 #任务"></textarea>
    ...
    const jm=new jsMind({
      ...
      const handleMindAction=(action,mode)=>{
        if(!action) return;
        closeMapIoMenu();
        switch(action){
          ...
          case 'import': triggerImport(mode); break;
      ...
      if(mapIoMenu){
        mapIoMenu.addEventListener('click',e=>{
          ...
          if(!item) return;
          e.preventDefault();
          const mode=item.dataset.mode || undefined;
          handleMindAction(item.dataset.action, mode);
        });
      }
      if(mapIo){
        document.addEventListener('pointerdown',e=>{
      ...
      function triggerImport(mode){
        if(mode){ pendingImportMode=mode; }
        if(!pendingImportMode){ pendingImportMode='replace'; }
      ...
      if(importInput){
        importInput.addEventListener('change', e=>{
          const file=e.target.files[0]; if(!file){ pendingImportMode='replace'; return; }
          ...
          reader.onload=evt=>{
            try{
              ...
              const chosen=pendingImportMode && ['replace','append-node','new-map'].includes(pendingImportMode) ? pendingImportMode : 'replace';
              pendingImportMode='replace';
              commitInlineEditing();
              if(mapDeleteButton && chosen!=='new-map'){ mapDeleteButton.disabled=!currentMapId; }
              switch(chosen){
                case 'replace':
                  jm.show(json);
    ...
    <style>
      ...
      *,*::before,*::after{box-sizing:border-box}
      ...
      body::after{content:"";position:fixed;inset:0;background:
        repeating-linear-gradient(0deg,rgba(75,195,209,.08) 0,rgba(75,195,209,.08) 1px,transparent 1px,transparent var(--grid-size)),
        repeating-linear-gradient(90deg,rgba(201,168,106,.12) 0,rgba(201,168,106,.12) 1px,transparent 1px,transparent var(--grid-size));
        mix-blend-mode:screen;opacity:.3;pointer-events:none;z-index:-4;
      }
      .scanlines{position:fixed;inset:0;pointer-events:none;z-index:-1;background:linear-gradient(to bottom,rgba(75,195,209,.12) 0,transparent 4px);background-size:100% 6px;opacity:.2}
      a{color:inherit;text-decoration:none}
      ...
      .btn{position:relative;padding:12px 18px;border-radius:16px;border:1px solid rgba(227,198,139,.62);background:linear-gradient(135deg,rgba(227,198,139,.82),rgba(170,140,84,.62));color:#1d1206;font:600 12px/1 'Inter','Noto Sans SC',sans-serif;text-transform:uppercase;letter-spacing:.16em;cursor:pointer;transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition);box-shadow:0 0 22px rgba(227,198,139,.25);overflow:hidden}
      .btn::after{content:none}
      .btn:hover{transform:translateY(-2px);border-color:rgba(227,198,139,.82);box-shadow:0 0 28px rgba(227,198,139,.32)}
      .btn.acc{background:linear-gradient(135deg,rgba(75,195,209,.85),rgba(36,194,160,.8));color:#041512;box-shadow:0 0 24px rgba(75,195,209,.35);border-color:rgba(75,195,209,.68)}
      .btn.danger{border-color:rgba(209,75,75,.65);color:#250b0b;background:linear-gradient(135deg,rgba(255,140,140,.82),rgba(209,75,75,.72));box-shadow:0 0 22px rgba(209,75,75,.28)}
      .btn:focus-visible{outline:2px solid var(--accent-cyan);outline-offset:3px}
      ...
      .grid{margin-top:28px;display:grid;gap:18px;grid-template-columns:repeat(auto-fit,minmax(min(100%,260px),1fr))}
  ...
  <div class="wrap">
      <div class="header">
        ...
        <div style="display:flex;gap:10px;flex-wrap:wrap">
          ...
          <button class="btn" type="button" id="maps-import-button">导入导图</button>
          <button class="btn" type="button" id="maps-export-button">导出全部</button>
        </div>
      </div>
      <div class="search">
        <span>🔍</span>
      ...
      <input id="maps-import-input" type="file" accept="application/json" hidden>
      <?php if (!$maps): ?>
        <div class="empty">
    ...
    <script>
      ...
      const importBtn=document.getElementById('maps-import-button');
      const exportBtn=document.getElementById('maps-export-button');
      const importInput=document.getElementById('maps-import-input');
      const mapsData=<?php echo json_encode(array_map(function($m){
        ...
        return [
          ...
          'content'=>$decoded,
          'content_raw'=>$decoded===null ? $m['content'] : null
        ];
      }, $maps), JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>;
      function enforceOrientationForList(node, depth=0){
        if(!node || typeof node!=='object') return;
        node.direction=depth===0?'center':'right';
        if(Array.isArray(node.children)){
          node.children=node.children.filter(child=>child && typeof child==='object');
          node.children.forEach(child=>enforceOrientationForList(child, depth+1));
        }else{
          node.children=[];
        }
      }
        ...
        importInput.addEventListener('change',e=>{
          ...
          reader.onload=evt=>{
            try{
              const json=JSON.parse(evt.target.result);
              if(!json || !json.data){ alert('文件格式不兼容'); return; }
              enforceOrientationForList(json.data,0);
              const title=(json.meta && typeof json.meta.name==='string' && json.meta.name.trim())
                || (json.data && typeof json.data.topic==='string' && json.data.topic.trim())
                || '导入导图';
              const fd=new FormData();
              fd.append('action','save_mindmap');
              fd.append('id','0');
              ...
              fetch(location.href,{method:'POST',body:fd,headers:{'X-Requested-With':'fetch'}})
                .then(res=>res.ok?res.json():Promise.reject(new Error('网络异常')))
                .then(data=>{
                  if(data && data.ok){
                    alert('导入成功');
                    location.reload();
                  }else{
                    throw new Error(data && data.error ? data.error : '导入失败');
                  }
                })
      ...
      if(exportBtn){
        exportBtn.addEventListener('click',()=>{
          if(!mapsData || !mapsData.length){ alert('暂无导图可导出'); return; }
          const sanitized=mapsData.map(map=>{
            const entry=Object.assign({}, map);
            if(entry.content_raw===null || entry.content_raw===undefined){ delete entry.content_raw; }
            return entry;
          });
          const payload={
          ...
          a.href=url;
          a.download=`mindmaps-all-${stamp}.json`;
          a.click();
          setTimeout(()=>URL.revokeObjectURL(url),1000);
        });
      }
...
<style>
  ...
  *,*::before,*::after{box-sizing:border-box}
  ...
  .scanlines{position:fixed;inset:0;pointer-events:none;z-index:-1;background:linear-gradient(to bottom,rgba(75,195,209,.14) 0,transparent 4px);background-size:100% 6px;opacity:.2}
  a{color:inherit;text-decoration:none}
  .app{display:block;min-height:100vh;position:relative;z-index:0}
  .sidebar{position:fixed;top:0;left:0;width:280px;height:100vh;overflow:auto;background:linear-gradient(165deg,rgba(12,14,18,.94) 0%,rgba(15,19,22,.9) 55%,rgba(21,26,30,.9) 100%);border-right:1px solid var(--border);box-shadow:inset 0 0 0 1px rgba(201,168,106,.08),0 18px 45px rgba(0,0,0,.45);padding:20px;backdrop-filter:blur(18px) saturate(170%);transition:transform var(--transition),box-shadow var(--transition);z-index:10}
  ...
  .btn{position:relative;display:inline-flex;align-items:center;justify-content:center;padding:10px 16px;border-radius:14px;border:1px solid rgba(227,198,139,.6);background:linear-gradient(135deg,rgba(227,198,139,.8),rgba(170,140,84,.6));color:#1c1208;font:600 12px/1 'Inter','Noto Sans SC',sans-serif;letter-spacing:.14em;text-transform:uppercase;text-decoration:none;box-shadow:0 0 20px rgba(227,198,139,.25);transition:transform var(--transition),border-color var(--transition),box-shadow var(--transition);overflow:hidden}
  .btn::after{content:none}
  .btn:hover{transform:translateY(-2px);border-color:rgba(227,198,139,.82);box-shadow:0 0 26px rgba(227,198,139,.32)}
  .btn:hover::after{content:none}
  .btn:active{transform:translateY(0);border-color:var(--gold-700)}
  .btn.acc{background:linear-gradient(135deg,rgba(75,195,209,.85),rgba(36,194,160,.8));color:#041512;box-shadow:0 0 22px rgba(75,195,209,.35);border-color:rgba(75,195,209,.68)}
  .btn.danger{color:#250b0b;border-color:rgba(209,75,75,.65);background:linear-gradient(135deg,rgba(255,140,140,.82),rgba(209,75,75,.72));box-shadow:0 0 22px rgba(209,75,75,.28)}
  ...
  .main{margin-left:280px;padding:32px 28px;background:linear-gradient(160deg,rgba(12,14,18,.82),rgba(10,12,14,.85));backdrop-filter:blur(14px) saturate(160%);position:relative;min-height:100vh}
  ...
  .items{display:grid;grid-template-columns:1fr;gap:24px;position:relative}
  ...
  .item::before{content:"";position:absolute;inset:6px;border-radius:14px;border:1px dashed rgba(201,168,106,.24);opacity:.75;pointer-events:none;box-shadow:inset 0 0 18px rgba(227,198,139,.12)}
  .item::after{content:"";position:absolute;top:14px;right:16px;width:11px;height:11px;border-radius:50%;background:var(--danger);box-shadow:0 0 12px var(--danger);opacity:.85}
  ...
  .item.done::before{opacity:1;border-style:double;border-color:rgba(201,168,106,.45);box-shadow:inset 0 0 22px rgba(227,198,139,.18)}
  ...
  .tinyline::before{content:"";position:absolute;left:6px;top:0;bottom:0;width:2px;background:linear-gradient(to bottom,rgba(201,168,106,.6),rgba(201,168,106,.12));box-shadow:0 0 12px rgba(201,168,106,.22)}
  ...
  .dot::after{content:"";position:absolute;inset:-5px;border-radius:50%;border:1px dashed rgba(201,168,106,.4);opacity:.85;box-shadow:0 0 16px rgba(201,168,106,.25)}
  ...
  .desk-move{display:inline-flex;gap:6px;flex-wrap:wrap}
  .desk-move .btn.small,.mob-move .btn.small{min-width:0}
  ...
  @media (max-width:920px){
    .app{padding-left:0}
    .sidebar{position:static;width:auto;height:auto;overflow:visible;border-right:0;border-bottom:1px solid rgba(201,168,106,.18);border-radius:0 0 22px 22px;box-shadow:0 18px 40px rgba(0,0,0,.55)}
      ...
      <?php foreach ($items as $it): ?>
        ...
        <article class="item <?php echo $it['done']?'done':''; ?>" data-id="<?php echo $it['id']; ?>">
          ...
          <div class="item-actions">
            ...
            <span class="tip note-tip">←→ / ↑↓ 按钮排序</span>
            <div class="desk-move" aria-label="桌面排序">
              <button type="button" class="btn small" onclick="moveCardHorizontal(<?php echo $it['id']; ?>,-1)">← 左移</button>
              <button type="button" class="btn small" onclick="moveCardHorizontal(<?php echo $it['id']; ?>,1)">→ 右移</button>
              <button type="button" class="btn small" onclick="moveCardVertical(<?php echo $it['id']; ?>,-1)">↑ 上移</button>
              <button type="button" class="btn small" onclick="moveCardVertical(<?php echo $it['id']; ?>,1)">↓ 下移</button>
            </div>
            <div class="mob-move" aria-label="移动端排序">
              <button type="button" class="btn small" onclick="moveCardVertical(<?php echo $it['id']; ?>,-1)">↑ 上移</button>
              <button type="button" class="btn small" onclick="moveCardVertical(<?php echo $it['id']; ?>,1)">↓ 下移</button>
            </div>
...
function moveCardByOffset(id, offset, clampRow=false){
  ...
  if(clampRow && columns>1){
    const currentRow=Math.floor(index/columns);
    const targetRow=Math.floor(targetIndex/columns);
    if(targetRow!==currentRow) return;
  }
  const target=cards[targetIndex]; if(!target) return;
  const current=cards[index];
  if(targetIndex>index){
    grid.insertBefore(current, target.nextSibling);
  }else{
    grid.insertBefore(current, target);
  }
  sendOrder();
}
function moveCardHorizontal(id, direction){
  const columns=getGridColumnCount();
  const clamp=columns>1;
  moveCardByOffset(id, direction, clamp);
}
function moveCardVertical(id, direction){
  const columns=getGridColumnCount();
  const offset=columns>1 ? direction*columns : direction;
  moveCardByOffset(id, offset, false);
}
function sendOrder(){
