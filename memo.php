  ...
  <head>
    ...
    <style>
      ...
      *,*::before,*::after{box-sizing:border-box}
      ...
      .attachment-preview-loading::before{content:"";width:44px;height:44px;border-radius:50%;border:3px solid rgba(201,168,106,.24);border-top-color:var(--gold-400);animation:attachment-preview-spin 1s linear infinite}
